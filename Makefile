...
GENERATED_INPUTS_DIR = $(DATA_DIR)/generated
TRACKS = $(GENERATED_INPUTS_DIR)/tracks.csv
CONFLICTS = $(GENERATED_INPUTS_DIR)/conflicts.csv
CPLEX = $(GENERATED_INPUTS_DIR)/schedule-cplex.lp
